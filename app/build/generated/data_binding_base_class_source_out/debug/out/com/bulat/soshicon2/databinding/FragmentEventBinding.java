...
public final class FragmentEventBinding implements ViewBinding {
  ...
  @NonNull
  public final ConstraintLayout containerEvent;

  @NonNull
  public final ListView listView;

  private FragmentEventBinding(@NonNull ConstraintLayout rootView,
      @NonNull ConstraintLayout containerEvent, @NonNull ListView listView) {
  ...
  public static FragmentEventBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      ConstraintLayout containerEvent = (ConstraintLayout) rootView;
      ...
      return new FragmentEventBinding((ConstraintLayout) rootView, containerEvent, listView);
    }
