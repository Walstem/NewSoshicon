...
public final class ChatBinding implements ViewBinding {
  ...
  private ChatBinding(@NonNull ConstraintLayout rootView, @NonNull ConstraintLayout containerChat) {
  ...
  public static ChatBinding bind(@NonNull View rootView) {
    ...
    return new ChatBinding((ConstraintLayout) rootView, containerChat);
  }
}
